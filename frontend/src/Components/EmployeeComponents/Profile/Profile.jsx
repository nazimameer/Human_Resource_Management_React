          ...
          <div class="col-span-full xl:col-auto">
            <div class="bg-white shadow-md shadow-gray-200 rounded-2xl p-4 mb-6">
              <div class="sm:flex xl:block sm:space-x-4 xl:space-x-0">
                ...
                />
                <div>
                  <h2 class="text-xl font-bold">{proDetails.fullname}</h2>
                ...
                <ul class="flex flex-wrap mt-4">
                  {isLength ? (
                    skills.map((obj, index) => {
                      return (
                        <li
                          class="bg-gradient-to-br from-green-500 to-green-700 text-xs font-bold uppercase text-white px-3 py-1.5 rounded-md mb-2 mr-2"
                          key={index}
                    ...
                    <li class="bg-gradient-to-br  text-xs font-bold uppercase text-black px-3 py-1.5 rounded-md mb-2 mr-2">
                      No Skills Provided
                    </li>
                  )}
                </ul>
            ...
            <div class="bg-white shadow-md shadow-gray-200 rounded-2xl p-4 mb-6">
              ...
              <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd class="text-sm font-semibold text-gray-900">Plus Two</dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd class="text-sm font-semibold text-gray-900">English</dd>
                </div>
                <div>
