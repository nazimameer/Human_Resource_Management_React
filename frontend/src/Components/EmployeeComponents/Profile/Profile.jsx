      ...
      <main className="bg-slate-900">
        <div className="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-6">
          ...
          <div className="col-span-2">
            ...
            <div className="skillbar bg-white shadow-md shadow-gray-200 rounded-2xl p-4 mb-4 overflow-y-scroll">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-1 md:gap-16 lg:gap-8 2xl:gap-24">
